...
namespace options {
    ...
    */
    ...
    struct   Ambiguous_option : public error_with_no_option_name
    {
    ...
    struct Invalid_command_line_syntax : public Invalid_syntax
    {
    ...
    struct Validation_error : public error_with_option_name
    {
            enum kind_t {
